...
//            return $this->hasMany('App\Model\Ticket\Ticket_attachments',);
//
//        }
    public function thread()
    {
        return $this->hasMany('App\Model\Ticket\Ticket_thread', 'ticket_id');
    }

    public function collaborator()
    {
        return $this->hasMany('App\Model\Ticket\Ticket_Collaborator', 'ticket_id');
    }

    public function formdata()
    {
        return $this->hasMany('App\Model\Ticket\Ticket_Form_Data', 'ticket_id');
    }
