...
//                        $id = DB::table('bdtdc_category')->insertGetId($category);
                        ...
                        $bdtdc_category->parent_id  = $categories;
                        $bdtdc_category->top        = $input['top'];
                        $bdtdc_category->status     = $input['status'];
                         $bdtdc_category->image      =  $file_name;
                        $bdtdc_category->save();
...
//        }     
    ...
    public function edit($id)
    {
        ...
        $category_id = explode(',',$parent_id);
        $parendetail=BdtdcCategory::with('category_name')->whereIn('id',$category_id)->get();
        ...
        //return $parent;
        return view('protected.admin.myB2B.edit_category',['categorys'=> $categorys,'categories'=>$categories,'parent'=>$parent,'cats'=>$cats,'parendetail'=>$parendetail]);
    }
