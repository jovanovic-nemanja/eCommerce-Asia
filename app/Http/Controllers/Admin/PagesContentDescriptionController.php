...
//                        ->get();
        $descriptions = BdtdcPageContentDescription::with('bdtdc_category')->orderBy('created_at', 'desc')->get();
...
//        return $descriptions[0]->bdtdc_page->name;
    ...
    public function store(Request $request)
    {
       ...
       // dd($insert_data);
        ...
        if($request->save==1){
            return redirect()->route('admin.description-manage')->with('flash_message', 'Content Description Successfully Added');
        } else {
            return redirect()->route('admin.description-add')->with('flash_message', 'Content Description Successfully Added');
        }
...
//            return redirect()->route('admin.description-edit/'.$id)->with('flash_message', 'Updated!!');
            ...
            $success = 'Content Description Successfully Updated';
            if($request->save==1){
                return redirect()->route('admin.description-manage')->with('flash_message', 'Content Description Successfully Updated');
            }else{
                return view('protected.admin.content_descriptions.description-edit',compact('description','pages','contents','success'));
            }
//            $description = BdtdcPageContentDescription::with('bdtdc_category')
