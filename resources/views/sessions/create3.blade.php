...
<div class="logo">
	<a href="#">
	<img src="resources/assets/admin/layout2/img/logo.png" height="50px" alt=""/>
	</a>
</div>
<!-- END LOGO -->
...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="{{ URL::route('sessions.store')}}" method="post">
	...
	<form class="forget-form" action="{{ URL::action('Auth\PasswordController@postEmail')}}" method="post">
	{!! csrf_field() !!}
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
	 2015 &copy; BDTDC - Admin Dashboard.
</div>
<!-- END COPYRIGHT -->
