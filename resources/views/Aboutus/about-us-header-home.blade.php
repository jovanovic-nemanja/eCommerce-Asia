...
<div class="container-fluid padding_0" style="padding-right: 0 !important; padding-left: 0 !important;margin-top: 100px;">
  ...
  <div id="submenu">
        <div class="container">
          ...
          <ul class="cont-submenu sub-id"  style="display: none; text-align: left;max-width: 75%">
            <li class="submenu-li" style=""><a href="{{URL::to('office',null) }}" class="submenu-li-a">Our Offices</a></li>
            <li class="submenu-li" style="padding-left:50px "><a href="{{URL::to('investor/relation/home',null) }}" class="submenu-li-a" target="_blank">Investor Relations Contacts</a></li>
            ...
            <li class="submenu-li" style="padding-left:50px "><a href="{{URL::to('contact_message_form',null) }}" class="submenu-li-a" target="_blank">Customer Service Contacts</a></li>
             ...
             <li class="submenu-li" style="padding-left:50px "><a href="{{URL::to('contact',null) }}" class="submenu-li-a" target="_blank">Contact Us</a></li>
...
$(document).ready(function(){
    ...
    $(".about-bd").click(function(){
        ...
        if($(this).attr('data-menu') == 'aboutus'){
          ...
          $(".about-submenu,.news-submenu,.cont-submenu").css("display", "none");
