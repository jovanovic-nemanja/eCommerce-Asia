...
<div class="row topbar_sha">
	<div title="Manufacturers-Suppliers" class="col-xs-12 col-sm-2">
		...
		<div style="margin-left: -6%;" id="bang-trade" onMouseOver="show_home()">Bangladesh Trade Development Council</div>
		...
		<div style="" class="col-xs-12 padding_0">
			...
			<input type="hidden" name="_token" value="{{ csrf_token() }}">
				...
				<div class="col-xs-4 padding_0">
					...
					<a title="get quote" href="{{URL::to('get_qutations',null)}}"><span style=""><img style="margin-left: 3px;margin-top: 0px;padding-right: 5px;margin-top: -3px;height: 49px" class="img-responsive" src="{!! asset('resources/assets/gold/Get-Quotation-home.png') !!}" /></span></a>
					</div>
				</div>
