...
<div class="container">
  <div class="row">
		<div class="col-md-12 padding_0" style="padding-bottom: 1%;margin-top: 1%;">
        ...
        <button class="goBack" onclick="goBack()"><span>Go Back</span></button>
					...
					<!-- content -->
					@if($title)
					<div class="row padding_0" style="height: 100vh;">
					<div class="col-sm-8" style="margin-top: 20vh;">
							<h1 style="font-size: 8vh; margin-bottom: 23px; text-transform: uppercase; font-weight: 700;">Estore not active yet!
							<span style="font-size: 3vh; display: block; text-transform: none; margin-top: 15px;">If you are the owner of this template, please <a href="{{URL::to('login',null)}}">login</a> and update your template or go to <a href="{{URL::to('ServiceChannel/pages/for_buyer', 35)}}">help center</a>.</span>
								 
							</h1>
							
						</div>
						<div class="col-sm-4">
							<img style="" src="{!! asset('resources/assets/fontend/bdtdc-images/smile.png') !!}" class="img-responsive" alt="">
						</div>
...
<div class="row padding_0">
		<div class="col-sm-12 col-md-12 padding_0" style="padding-top: 90px;">
					<div class="col-sm-7 col-md-7">
							<h1 id="overview-h1" style="margin-bottom: 0;">Bdtdc NEWS</h1>
					</div>
...
<div class="row padding_0">
	...
	<div class="col-sm-8 col-md-8 col-lg-8 padding_0" style="border-right: 2px dotted #e5e5e5;">
            ...
            <ol class="carousel-indicators">
	         ...
	         <div class="carousel-inner" role="listbox">
                <div class="item">
                 <img style="max-height:350px;width:100%;margin-left: -1px;" src="http://www.bditdc.com/resources/assets/fontend/bdtdc-images/banner02.jpg" alt="">
                </div>
            
                <div class="item">
                  <img style="max-height:350px;width:100%;margin-left: -1px;" src="http://www.bditdc.com/resources/assets/fontend/bdtdc-images/logistic-image222.jpg" alt="">
                </div>
            
                <div class="item active">
                  <img style="max-height:350px;width:100%;margin-left: -1px;" src="http://www.bditdc.com/resources/assets/fontend/bdtdc-images/logistic-image444.jpg" alt="">
                </div>
            
                <div class="item">
                  <img style="max-height:350px;width:100%;margin-left: -1px;" src="http://www.bditdc.com/resources/assets/fontend/bdtdc-images/team2.jpg" alt="">
                </div>
            </div>
				...
				<div class="co-sm-12 col-lg-12 col-md-12 padding_0">
					...
					<div class="irHighlightBox" style="margin:5px 3px 0px -10px">
			                <h2 class="irHighlightBox-h2">Bdtdc Group Announces March Quarter 2016 and Full Fiscal Year 2016 Results</h2>
			            ...
			            <div class="listItem">
						    <h2 class="irHighlightBox-h2">Bdtdc Group and New Zealand Government Form Strategic Alliance to Strengthen Trade with Bangladesh</h2>
						    <div class="bdc-date">April 18, 2016</div>
						    <div class="bdc-content">Dhaka, April 18, 2016 – Bdtdc Group, the world’s largest online and mobile marketplace, and New Zealand Trade and Enterprise (NZTE), the New Zealand Government’s international business development agency ...</div>
						    <div class="tools"><a href="#" target="_blank">View</a> </div>
						</div>
						 <div class="listItem">
						    <h2 class="irHighlightBox-h2">Bdtdc Group Will Announce March Quarter 2016 and Full Fiscal Year 2016 Results on May 5, 2016</h2>
						    <div class="bdc-date">April 18, 2016</div>
	...
	<div class="col-sm-3 col-md-3 col-lg-3">
        	...
        	<div class="irSideBox">
                ...
                <a href="../news/video">Bdtdc Videos</a><br>
