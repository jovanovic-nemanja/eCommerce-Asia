                     ...
                     <table class="table company_information_table">
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>{{ ($product_capacity) ? $product_capacity->form_factory_size->value : "" }}</td>
                           </tr>
                           <tr>
                              <td style="color:#666">Factory Location:</td>
                              <td>{{ ($product_capacity) ? $product_capacity->factory_location : ""  }}</td>
                           </tr>
                           <tr>
                              <td style="color:#666">No. of Production Lines</td>
                              <td>{{ ($product_capacity->form_no_of_production_line) ? $product_capacity->form_no_of_production_line->value : ""  }}</td>
                           </tr>
                           <tr>
                              <td style="color:#666">Contract Manufacturing</td>
                              <td>{{ ($product_capacity) ? $product_capacity->contact_manufacturing : ""  }} </td>
                           </tr>
                           <tr>
                              <td style="color:#666">Annual Output Value:</td>
                              <td>{{ ($product_capacity) ? $product_capacity->form_anual_value->value : ""  }} </td>
                           </tr>
                           @endif
                        </tbody>
                     </table>
