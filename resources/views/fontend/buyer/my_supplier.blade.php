...
<div class="row" style="padding-top: 1%;padding-bottom: 0.5%">
	...
	<div class="row" id="row" style="background-color: #fff; margin-bottom: 2%" >
		<div class="col-sm-12 padding_0">
			...
			<div class="col-sm-10" style="padding-right: 0px">
				...
				<div class="col-sm-12 padding_0" style="margin:10px 0;">
					<div class="col-sm-6 padding_0" style="font-size: 20px;">My Suppliers</div>
					<div class="col-sm-6 padding_0 text-right"><a href="{{ URL::to('source') }}">What is a BDSource Supplier?</a></div>
				</div>
