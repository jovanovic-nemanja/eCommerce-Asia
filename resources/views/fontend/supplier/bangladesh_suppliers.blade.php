...
@section('page_css')
<link property='stylesheet' href="{!! asset('css/footer-bottom/bangladesh-suppliers.css') !!}" rel="stylesheet">
<link property='stylesheet' href="{!! asset('assets/fontend/custom.min.css') !!}" rel="stylesheet">
...
{{-- <link property='stylesheet' href="{!! asset('assets/fontend/topbar/css/animate.min.css') !!}" media="all" rel="stylesheet" type="text/css" /> --}}
...
<div class="row" style="padding-top:2%;padding-bottom:0%">
   ...
   <div class="col-md-12 padding_0" style="padding-bottom: 1%">
      <ul style="margin-left: -2%" itemscope itemtype="http://schema.org/BreadcrumbList">
         ...
         <li style="float: left" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
            <a itemprop="url" href="" style="color: #000"> <i class="fa fa-angle-right"></i> <span itemprop="name">Bangladesh Suppliers</span> <i class="fa fa-angle-right"></i>
            </a>
...
<div class="col-sm-9 col-md-10 col-xs-12 padding_0" style="border-left: 1px solid #ddd;padding-top: 10px">
   <p style="padding-left: 28px">Related Searches for Bangladesh Suppliers: <a itemprop="url" target="_blank" href="{{URL::to('selected-suppliers/bangladesh-products/18')}}">Bangladesh Products</a></p>
   <div class="col-sm-12 col-md-12 col-xs-12 padding-right" style="padding-bottom: 0.5%">
      <form action="{{ URL::to('others_filter',null) }}" class="form others_filter_form" method="post">
         ...
         <div class="col-sm-4 col-md-4 col-xs-12">
            ...
            <div style="margin-bottom:2%" class="col-sm-6 col-md-6 col-xs-12 padding_0 ">
               ...
               <div style="background-color: #fff;border: 1px solid #dae2ed;cursor: pointer;    display: inline-block;height: 24px;    line-height: 22px;padding: 0 0 0 5px;    width: 192px;    vertical-align: middle;color: #333;margin-top: 4px;" class="country_tab">
                  ...
                  <div style="position:absolute;border: 1px solid #dae2ed;box-shadow: 2px 2px 3px rgba(0,0,0,.13);background-color: #fff;top: 27px;left: -120px;padding: 10px;overflow: auto;height: 250px;width: 450%;z-index: 1;" class="">
                     <div style="border-bottom: 1px dotted #dae2ed;    padding-bottom: 10px;">
                        <div class="replace_name" style="background: #7d8ca1;color: #fff;font-size: 12px;    line-height: 26px;width: 162px;padding-left: 7px;    border-radius: 5px !important;">
                           <?php if($country_id != 0){foreach ($bdtdc_country_list as $value) {
					    	if($country_id == $value->id){
					    		echo $value->name. " Selected";
					    	}
                     ...
                     <ul class="nav nav-tabs">
                        ...
                        <?php
								foreach ($country_data as $Countries_data) {
									echo '<li><a itemprop="url"  data-toggle="tab" href="#'.explode(' ', $Countries_data->name)[0].'">'.$Countries_data->name.'</a></li>';
									/*$region = $Countries->name;
									$counter = 0;
									foreach($Countries->country_region as $p){
										$counter = count($p->contry_products);
										if($counter > 0){
										echo '<li><a itemprop="url" itemprop="url" itemprop="url" data-toggle="tab" href="#'.explode(' ', $region)[0].'">'.$region.'</a></li>';
										break;
										}
									}*/
								}
                     ...
                     <div class="tab-content">
                        <div id="all-con" class="tab-pane fade in active">
                           <div class="col-md-3 padding_0">
                              <div class="country_select" style="cursor:pointer;" countryid="0"> All</div>
                           </div>
                           <?php
								foreach ($country_data as $Countries_data) {
         ...
         <div class="col-sm-8 col-md-8 col-xs-12" style="padding-top:0px;text-align: right;">
            ...
            <label style="font-size:12px;cursor: pointer;" class="ui2-checkbox-customize-label">
               <input style="position: relative; top: 3px;cursor: pointer;" name="trade_assurence" type="checkbox" class="ui2-checkbox-customize-val others_filter_form_input" value="0" <?php if($buyer_protection == 'true'){echo 'checked';} ?>>
               <span class="ui2-checkbox-customize-txt"><img style="height:25px;width:25px;" src="{!! asset('assets/gold/Buyer-protection-home.png') !!}" alt="Buyer Protection">Buyer Protection</span>
            </label>
            <label style="font-size:12px;cursor: pointer;" class="ui2-checkbox-customize-label">
               <input style="position: relative; top: 3px;cursor: pointer;" name="gold_supplier" type="checkbox" class="ui2-checkbox-customize-val others_filter_form_input" value="0" <?php if($gold_supplier == 'true'){echo 'checked';} ?>>
               <span class="ui2-checkbox-customize-txt"><img style="height:25px;width:25px;" src="{!! asset('assets/helpcenter/Gold-membership.png') !!}" alt="Gold Supplier">Gold Supplier</span>
            </label>
            <!-- </a> -->
            <label style="font-size:12px;cursor: pointer;" class="ui2-checkbox-customize-label">
               <input style="position: relative; top: 3px;cursor: pointer;" name="assessed_supplier" type="checkbox" class="ui2-checkbox-customize-val others_filter_form_input" value="0" <?php if($assessed_supplier == 'true'){echo 'checked';} ?>>
               <span class="ui2-checkbox-customize-txt"><img style="height:25px;width:25px;" src="{!! asset('assets/helpcenter/verified-supplier.png') !!}" alt="Assessed Supplier">Assessed Supplier</span>
            </label>
         </div>
      </form>
   </div>
   ...
   <div id="pro_view" class="col-sm-12 col-md-12 col-xs-12 padding-right" data-spm="57">
      ...
      <div class="col-sm-4 col-md-4">
         <div class="view-label" style="padding: 8px; text-align:center !important;">Showing @if(isset($suppliers))
            <strong>{{$suppliers->total()}}</strong> @else
            <strong>0</strong> @endif Bangladesh Suppliers
         </div>
      </div>
      <div class="col-sm-4 col-md-4">
         <div class="view-label" style="padding: 8px; text-align:center !important;">Page No @if(isset($suppliers))
            ...
            @endif |
            <a itemprop="url" href="{{$suppliers->previousPageUrl()}}">prev</a> |
            <a itemprop="url" href="{{$suppliers->nextPageUrl()}}">next</a>
            @else
            <strong>0</strong>
            @endif
         </div>
   ...
   <br>
   <div class="col-sm-12 col-md-12 col-xs-12 padding-right" style="padding-top:2%;">
         ...
         <div class="list_product col-xs-12" style=" border-bottom: 1px solid #ddd; margin-bottom: 1% ">
            <div class="col-sm-12 padding_0">
               <div class="col-sm-9 padding_0">
                  ...
                  @if($s->is_gold==1)
                  @if($s->is_gold==1)
                  <img style="height: 25px;width: 25px;float:left;" src="{{ asset('assets/gold/Gold-membership.jpg')}}" alt="Gold Supplier" />

                  @else
                  <img style="height: 25px;width: 25px; float:left;" src="{{ asset('assets/gold/bdtdc-free.jpg')}}" alt="free membership" />
                  @endif
                  @else
                  <img style="height: 25px;width: 25px;float:left;" src="{{ asset('assets/gold/bdtdc-free.jpg')}}" alt="free membership" />
                  @endif
                  ...
                  <p class="comp_title">
                     ...
                     <a itemprop="url" target="_blank" href="{{ URL::to('Home/'.preg_replace('/[^A-Za-z0-9\-]/', '-',$s->name_string->name),$s->id) }}"><?php if($s->users){echo $s->users->first_name;}else{echo "name not available";} ?> - <?php if($s->name_string){echo $s->name_string->name;}else{echo "name not available";} ?></a>
               ...
               <div class="col-sm-3">
				...
				?>
                     ...
                     <form action="{{URL::to('make-favorite')}}" method="post">
                        ...
                        <a class="fa fa-minus-square btn favorite" style="float: right;padding:0;" itemprop="url" data-key="{{$s->name_string->name ?? '' }}" data-id="{{$s->id}}" data-type="2"> Remove from favorite</a>
                        @else
                        <a class="fa fa-plus-square btn favorite" style="float: right;padding:0;" itemprop="url" data-key="{{$s->name_string->name ?? '' }}" data-id="{{$s->id}}" data-type="2"> Add to favorite</a>
                        @endif
                        @else
               ...
               <div class="col-xs-12 col-md-12 col-sm-12 padding_0">
                  <div style="padding-bottom:10px; padding-left:15px;" class="col-xs-6 col-md-4 col-sm-4 padding_0">
                     @if(isset($s->name_string))
                     <a itemprop="url" href="{{ URL::to('contact/'.preg_replace('/[^A-Za-z0-9\-]/', '-',$s->name_string->name),$s->id) }}" data-id="{{ $s->user_id }}">
            ...
            <div class="col-xs-7 col-md-2 col-sm-4 padding_0">
               <div class="product-image-wrapper">
                  <a itemprop="url" target="_blank" class="" href="{{ URL::to('product-details/'.preg_replace('/[^A-Za-z0-9\.-]/', '-', $p->pro_to_cat_name->name).'='.mt_rand(100000000, 999999999).$p->product_id) }}" style="display: block;">
                     <div class="single-products">

                        <div class="productinfo text-center">
                           <?php
									$img_url = URL::to('uploads/no_image.jpg');
									if($p->pro_images_new){
										if($p->pro_parent_cat && $p->bdtdcCategory){
											$img_url = URL::to('bdtdc-product-image/'.trim($p->pro_parent_cat->name).'/'.trim($p->bdtdcCategory->name).'/'.$p->pro_images_new->image,null);
										}else{
											$img_url = URL::to('uploads/no_image.jpg',null);
										}
									}else if($p->pro_images){
										$img_url = URL::to('uploads/'.$p->pro_images->image,null);
									}
									?>
                           @if($p->pro_images_new)

                           <img title="{{ $p->pro_to_cat_name->name ?? '' }}" style="height:120px;width:250px" class="img-thumbnail" src="{{ asset(''.$p->pro_images_new->image) }}" alt="{{ $p->pro_to_cat_name->name ?? '' }}" />


                           @else
                           <img title="{{ $p->pro_parent_cat->name ?? '' }}" style="width:250px;height:120px;margin-left:0" src="{{ asset('uploads/no-image.jpg') }}" class="img-responsive" alt="{{ $p->pro_parent_cat->name ?? '' }}">
                           @endif
                           <span class="pro_name" style="display: block; font-size: 12px;line-height: 13px;margin-top:0%">{{ substr($p->pro_to_cat_name->name,0,25) }}...</span>
                           <!-- <a itemprop="url"  target="_blank" class="pro_name" href="{{ URL::to('product-details/'.preg_replace('/[^A-Za-z0-9\.-]/', '-', $p->pro_to_cat_name->name).'='.mt_rand(100000000, 999999999).$p->product_id) }}" style="display: block; font-size: 12px;line-height: 13px;margin-top:0%">{{ substr($p->pro_to_cat_name->name,0,25) }}...</a> -->
                        </div>
            ...
            <div class="col-xs-7 col-md-2 col-sm-4 padding_0">
               <div class="product-image-wrapper">
                  <a itemprop="url" target="_blank" class="" href="#" style="display: block;">
                     <div class="single-products">
                        <div class="productinfo text-center">
                           <img title="" style="width:100%;height:120px;margin-left:0" src="{{ asset('uploads/no_image.jpg')}}" class="img-responsive" alt="Bangladeshi Suppliers">
                           <span class="pro_name" style="display: block; font-size: 12px;line-height: 13px;margin-top:0%"></span>
                        </div>
            ...
            <div class="col-xs-7 col-md-6 col-sm-12 padding_0" style="padding-left: 10px">
               <div style="padding-left: 15px;" class="col-xs-12 padding_0 left_sh">
                  <div class="col-sm-12 col-md-12 padding_0">
                     <p class="summary"><span style="margin-right:10px;">Main Product: </span>
                        ...
                        <a itemprop="url" href="#" class="main_product_search" data-main-product-text="{{$s->main_products->product_name_1}}" target="_blank">
                           <i class="fa fa-product-hunt"></i> {{$s->main_products->product_name_1}}
                        </a>
                        @endif
                        @if(trim($s->main_products->product_name_2) != '')
                        <a itemprop="url" href="#" class="main_product_search" data-main-product-text="{{$s->main_products->product_name_2}}" target="_blank">
                           <i class="fa fa-product-hunt"></i> {{$s->main_products->product_name_2}}
                        </a>
                        @endif
                        @if(trim($s->main_products->product_name_3) != '')
                        <a itemprop="url" href="#" class="main_product_search" data-main-product-text="{{$s->main_products->product_name_3}}" target="_blank">
                     ...
                     <p class="summary">Country/Region:
                        <a itemprop="url" style="padding-left:12px" class="country_click_search" href="<?php if($s->location_of_reg_string){echo $s->location_of_reg_string->id;}else{} ?>" target="_blank"><?php if($s->location_of_reg_string){echo $s->location_of_reg_string->name;}else{echo "not available";} ?></a>
                     </p>
                     <p class="summary">Total Revenue:
                        <a itemprop="url" class="margin_supp revenue_click_search" href="<?php if($s->tradeinfo){if($s->tradeinfo->BdtdcFormValue){echo $s->tradeinfo->BdtdcFormValue->id;}else{echo '0';}}else{echo '0';} ?>"><?php if($s->tradeinfo){if($s->tradeinfo->BdtdcFormValue){echo $s->tradeinfo->BdtdcFormValue->value;}else{echo "None";}}else{echo "None";} ?></a>
                     </p>
                     <p class="summary">Top Markets:
                        <span class="margin_supp"><a itemprop="url" href="#" target="_blank">{{ get_market_distribution($s->id) }}</a></span>
                     </p>
                  </div>
               </div>
            </div>
            <div class="col-sm-12 padding_0">
               <div style="float:right" class="col-sm-4 padding_0">
                  <ul style="float:left" class="list-inline">
                     <li><a itemprop="url" href="#" data-product_id="#" data-supplier_id="{{ $s->user_id }}" class="btn btn-primary btn-sm contact_supplier"><i class="fa fa-envelope-o"></i>Contact Supplier</a></li>
                     <?php
                     ...
                     <li>
                        ...
                        <a itemprop="url" class="chat_single" data-target-id="{{ $s->user_id.mt_rand(100000000, 999999999) }}" href="">Talk to me</a>
                        @else
                        <i class="fa fa-weixin"></i><a itemprop="url" class="contact_supplier" data-product_id="#" data-supplier_id="{{ $s->user_id }}" href="#">Talk to me</a>
                        @endif
                     </li>
                  </ul>
               </div>
...
<!-- search_result_aside.php div close -->
