...
g
	<div id="item_sha" class="col-sm-9 col-md-10 col-xs-12 padding-right" style="padding-bottom:1%">
	dsg
				...
				<div style="margin-top: 1%;padding-left:2%;position: relative;" class="col-sm-8 col-md-8 col-xs-12 padding_0 ">
					...
					<div style="position:absolute;border: 1px solid #dae2ed;box-shadow: 2px 2px 3px rgba(0,0,0,.13);background-color: #fff;top: 21px;left: -120px;padding: 10px;overflow: auto;height: 250px;width: 300%;z-index: 1;" class="">
					  <div style="border-bottom: 1px dotted #dae2ed;    padding-bottom: 10px;">
					  	<div class="replace_name" style="background: #7d8ca1;color: #fff;font-size: 12px;    line-height: 26px;width: 162px;padding-left: 7px;    border-radius: 5px !important;"><?php if($country != 0){foreach ($bdtdc_country_list as $value) {
					    	if($country == $value->id){
					    		echo $value->name. " Selected";
					    	}
			...
			@foreach($products as $product)
				<div style="width: 100%;" class="list_product col-xs-12 ">
					<div class="col-xs-7 col-md-2 col-sm-4 padding_0">
						...
						<img style="height:150px;width:100%" class="img-thumbnail" src="{{ URL::to('uploads',(isset($pro_img->image)) ? $pro_img->image : 'no_image.jpg',null) }}" alt="" />
						@else
							@if($product->bdtdcProductToCategory)
								...
								<img style="height:150px;width:100%" class="img-thumbnail" src="{{ URL::to('bdtdc-product-image/'.trim($product->bdtdcProductToCategory->pro_parent_cat->name).'/'.trim($product->bdtdcProductToCategory->bdtdcCategory->name),(isset($pro_img_new->image)) ? $pro_img_new->image : 'no_image.jpg',null) }}" alt="" />
								@else
								<img style="height:150px;width:100%" class="img-thumbnail" src="{{ URL::to('uploads/no-image.jpg',null) }}" alt="" />
								@endif
							@else
							<img style="height:150px;width:100%" class="img-thumbnail" src="{{ URL::to('uploads/no-image.jpg',null) }}" alt="" />
							@endif
					...
					<div class="col-xs-6 col-md-6 col-sm-8">
						<div class="col-xs-12 padding_0">
							...
							@endif">{{ $product->product_name->name or '' }}</a></p>
