				...
				<div style="margin-bottom:2%" class="col-sm-6 col-md-6 col-xs-12 padding_0 ">
					...
					<div style="position:absolute;border: 1px solid #dae2ed;box-shadow: 2px 2px 3px rgba(0,0,0,.13);background-color: #fff;top: 27px;left: -120px;padding: 10px;overflow: auto;height: 250px;width: 450%;z-index: 1;" class="">
					  <div style="border-bottom: 1px dotted #dae2ed;    padding-bottom: 10px;">
					  	<div class="replace_name" style="cursor: pointer;background: #7d8ca1;color: #fff;font-size: 12px;    line-height: 26px;width: 162px;padding-left: 7px;    border-radius: 5px !important;"><?php if($country_id != 0){foreach ($bdtdc_country_list as $value) {
					    	if($country_id == $value->id){
					    		echo $value->name. " Selected";
					    	}
...
<script type="text/javascript">
			...
			function search_data(){
		        ...
		        var main_url_array = main_url.split("/");
		        var url = window.location.origin+'/'+main_url_array[3]+'/pages?c='+country+'&k='+key+'&bp='+buyer_protection+'&gs='+gold_supplier+'&as='+assessed_supplier+'&fm='+filter_by_main_market+'&ftr='+filter_by_total_revanue+'&fe='+filter_by_employe+'&bt='+business_type;
		        // alert (url);
