...
<?php $dashboard_route = 'company/dashboard'; ?>
 @if (Sentinel::check())
            <?php
...
<div class="col-sm-12 col-md-12 col-xs-12" style="padding: 0;">
	<?php
		...
		if($supplier_inquiry){
			...
			}else if($supplier_inquiry->inq_docs_one){
		...
		<div class="row">
			...
			<div style=" overflow: hidden; padding: 15px;">
				...
				<div class="con-process" style="padding-top: 10px;overflow: hidden;">
					<div class="por-process por-active"><span>1</span><p>Start Order</p><div class="por-process-bar"></div>	</div>
					<div class="por-process"><span>2</span><p>Seller Confirm</p><div class="por-process-bar"></div>	</div>
					<div class="por-process"><span>3</span><p>Payment</p><div class="por-process-bar"></div>	</div>
					<div class="por-process"><span>4</span><p>Shipment</p><div class="por-process-bar"></div>	</div>
					<div class="por-process"><span>5</span><p>Success</p><div class="por-process-bar"></div>	</div>
				</div>	
				<div class="con-ask">
				...
				<div class="con-prod">
				<div class="show-prod">
					<div style=" border: 1px solid #ddd;" class="none"><p style="line-height: 100px; color:gray" class="text-center">None Selected</p></div>
				</div>
						...
						<div style=" width: 100%;">
							  ...
							  <a  class="btn btn-default cona-btn" data-toggle="modal" data-target="#selectProduct" style="margin-left: 0;">Add a listed product</a> 
							   </p>
							  <p style="text-align: center; margin-top: 10px;">
				...
				<div class="con-desc">
					<h3 style="margin-top: 0; margin-bottom: 15px; font-size: 18px;">Shipping <span style="font-size: 12px; color:#b0b0b0" class="pull-right">Unsupported Regions?</span></h3>
						  ...
						  <div class="form-group" style="max-width: 562px;text-align: left;margin: auto; margin-top: 5px;">
						    <label style="width: 135px; text-align:left;margin-right: 10px" for=""><span style="color:red">*</span>Shipping Method:</label>
						  ...
						  <div class="form-group" style="max-width: 562px;text-align: left;margin: auto; margin-top: 5px;">
						    <label style="width: 135px; text-align:left;margin-right: 10px" for="">Trade terms:</label>
						  ...
						  <div class="form-group" style="max-width: 562px;text-align: left;margin: auto; margin-top: 5px;">
						    <label style="width: 135px; text-align: left;margin-right: 10px" for="">Shipping Fee:</label>
						    <input type="text" name="shipping_fee" class="form-control check_number" id="" min="0" max="9999999999" style="flex: 1" value="0" required>
						  </div>
						  <div class="form-group" style="max-width: 562px;text-align: left;margin: auto; margin-top: 5px;">
						    <label style="width: 135px; text-align: left;margin-right: 10px" for="">Insurance Charge:</label>
						    <input type="text" name="insurance_charge" class="form-control check_number" min="0" max="9999999999" style="flex: 1" value="0" required>
						  </div>
						  <div class="form-group" style="max-width: 562px;text-align: left;margin: auto; margin-top: 5px;">
						    <label style="width: 135px; text-align: left;margin-right: 10px" for="">Shipment Date:</label>
						    <label><input type="radio" name="shipment_date_type" class="" value="specific-day" checked=""> Ship on specific day</label>
						  </div>
						  <div class="form-group specific_date_area" style="max-width: 562px;text-align: left;margin: auto; margin-top: 5px;">
						  ...
						  <div class="form-group after_payment_area" style="max-width: 562px;text-align: left;margin: auto; margin-top: 5px;display:none;">
						    <label style="width: 135px; text-align: right;margin-right: 10px" for=""></label>
				...
				<div class="con-desc">
					<h3 style="margin-top: 0; margin-bottom: 15px; font-size: 18px; line-height: 25px; padding-bottom: 15px;">Payment Details <span style="font-size: 12px; color:#b0b0b0" class="pull-left">Payment Methods and Processing Fee?</span></h3>

						  <div class="form-group" style="max-width: 562px;text-align: left;margin: auto; margin-top: 5px;">
						    <label style="width: 135px; text-align:left;margin-right: 10px" for="">Initial payment:</label>
						    <p style="margin:0;padding: 0;padding-top: 10px;">
							<div class="input-group">
							  <span class="input-group-addon">$</span>
							  <input type="text" class="form-control check_number" style="z-index: 1;" aria-label="Amount (to the nearest dollar)" max="9999999999" min="0" name="initial_payment" value="0" required>
							</div>
						    </p>
						  </div>

						  <div class="form-group" style="max-width: 562px;text-align: left;display: flex;margin: auto; margin-top: 5px;">
						    <label style="width: 135px; text-align: left;margin-right: 10px" for="">Balance payment:</label>
						    <p style="margin:0;padding: 0;padding-top: 10px;">US $ <span class="total_price_after">0</span></p>
							  
						  </div>
						  <div class="form-group" style="max-width: 562px;text-align: left;display: flex;margin: auto; margin-top: 5px;">
						    <label style="width: 135px; text-align: left;margin-right: 10px" for="">Payment methods:</label>
						  ...
						  <div class="form-group" style="max-width: 562px;text-align: left;margin: auto; margin-top: 5px;">
						    <label style="width: 135px; text-align: left;margin-right: 10px" for=""></label>
						    <a src="#" style="float: left;">Learn more about funds arrival time and processing fee</a>
						  </div>
				...
				<div class="con-desc" style="border: 1px solid lightblue">
					<h3 style="margin-top: 0; margin-bottom: 15px; font-size: 18px;">Trade Assurance <span style="font-size: 12px; color:#b0b0b0" class="pull-left">Quality Dispute and Shipping Delay Coverage?</span></h3>
...
<div class="modal fade" id="selectProduct" role="dialog">
    <div class="modal-dialog" style="width:100%; top: 40px; height: auto;">
          	...
          	<div class="next-search-normal next-search">
          		<div class="next-search-lft">
		         	<div style="float: left;">
		         	  <span placeholder="Please entry products"  value="" class="nxt-slect"><div class="next-select-inner-wrapper"><div class="next-select-inner">
		         	  <input style="border:0 none; text-align: left;float: left;padding-left: 10px; width: 100%;" id="myInput" onkeyup="myFunction()" tabindex="0" value="" placeholder="Please entry products" ></div></div></span>
		         	  </div>
		         </div>
          	...
          	<div class="row nxt-row">
          		<div class="col-sm-12">
					  ...
					  <ul class="nav nav-pills">
					    <li class=""><a class="search_class" data-toggle="pill" href="#all" data-sid="all"><i id="click_advance" class="fa fa-angle-down" aria-hidden="true" style="display:inline;padding-left: 5px;padding-right: 7px;"></i> All</a></li>
					    <?php $menu_no = 1; ?>
									...
									@foreach($supplier_products as $sps)
										<li title="{{$sps->product_name?$sps->product_name->name:'not available'}}" data-pid="{{$sps->id}}">
											...
											<div class="product-product-name">
													<span style="font-size: 11px;"><a target="_blank" href="{{ URL::to('product-details/'.preg_replace('/[^A-Za-z0-9\.-]/', '-',($sps->product_name?$sps->product_name->name:'not available')).'='.mt_rand(100000000, 999999999).$sps->id,null) }}">{{$sps->product_name?$sps->product_name->name:'not available'}}</a></span>
											</div>
										</li>
									@endforeach
									@endif
								...
								<div class="product-select-body">
									...
									@foreach($spg->BdtdcSupplierProductGroupsProducts as $sgp)
										<li title="{{$sgp->product_name?$sgp->product_name->name:'not available'}}" data-pid="{{$sgp->id}}">
											...
											<div class="product-product-name">
													<span style="font-size: 11px;"><a target="_blank" href="{{ URL::to('product-details/'.preg_replace('/[^A-Za-z0-9\.-]/', '-',($sgp->product_name?$sgp->product_name->name:'not available')).'='.mt_rand(100000000, 999999999).$sgp->id,null) }}">{{$sgp->product_name?$sgp->product_name->name:'not available'}}</a></span>
											</div>
										</li>
									@endforeach
									@endif
  ...
  template += '<div class="con-p-info" style="max-width: 790px; margin: auto; margin-bottom: 5px;">\
   ...
   template +=  '<div style="width: 790px; margin: auto;">\
	...
	$(document).on({change:function(){
            ...
            var size="",type="",src="",reader,img_file;
