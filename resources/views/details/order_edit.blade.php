      ...
      <div class="col-sm-10" style="padding-right: 0px">
         ...
         <div class="item_sha" style="margin-bottom:2%;">
            <div class="row" style="margin: 0">
               ...
               @endif
               <div class="col-sm-12">
                  <p style="font-size: 14px;color: #919191;margin-bottom: 0">@if(substr($quote_id, 9, -9) == 0)
                     Order Type:
                     @else
                     Enquiry for:
                     @endif
                  ...
                  <div class="show_elements" style="display: none; padding: 10px 0">
                     <div class="col-sm-12">
                        ...
                        <div class="col-sm-9">
                           ...
                           <p style="color: #999;">Preferred Unit Price: @if(trim($supplier_inquiry->currency == ''))
                              USD
                              @else
                              {{ $supplier_inquiry->currency}}
                              @endif
                              {{ $supplier_inquiry->pre_unit_price }} / @if($supplier_inquiry->inq_unit_id)
                              {{ $supplier_inquiry->inq_unit_id->name}}
                              @endif
                           </p>
                           @endif
                  ...
                  <div class="col-sm-12" style="padding-right: 15px;">
                     <div style=" overflow: hidden; padding: 15px;">
                        <div class="con-process" style="padding-top: 10px;overflow: hidden;">
                           <div class="por-process por-active"><span>1</span>
                              <p>Start Order</p>
                              <div class="por-process-bar"></div>
                           </div>
                           <div class="por-process"><span>2</span>
                              <p>Seller Confirm</p>
                              <div class="por-process-bar"></div>
                           </div>
                           <div class="por-process"><span>3</span>
                              <p>Payment</p>
                              <div class="por-process-bar"></div>
                           </div>
                           <div class="por-process"><span>4</span>
                              <p>Shipment</p>
                              <div class="por-process-bar"></div>
                           </div>
                           <div class="por-process"><span>5</span>
                              <p>Success</p>
                              <div class="por-process-bar"></div>
                           </div>
                        </div>
                        <div class="con-ask">
                           ...
                           <p class="pull-right" style="display: inline-block;margin:0;line-height: 37px;padding-right: 30px"><a href="#">Ask supplier to draft order</a></p>
                        </div>
                        <div class="con-desc">
                           ...
                           <div class="con-prod">
                              <div class="show-prod">
                                 ...
                                 @foreach($order->BdtdcOrderDetails as $order_details)
                                 <div class="con-pp">
                                    <hr>
                                    <div class="con-p-info" style="max-width: 790px; margin: auto; margin-bottom: 5px;">
                                       <input type="hidden" name="selected_products[]" value="{{$order_details->product_id}}" required>
                                       <span class="index" style="margin-right: 5px"></span>
                                       <div style="height: 100px;width: 100px;text-align: center;border: 1px solid #ddd;"><img class="thunbnail" width="100" height="100" src="{{URL::to($order_details->product_image,null)}}" style=""><input style="display:none;" type="file" name="product_image[]" class="image_p"></div>
                                       <textarea name="product_name[]" style="flex: 1;padding: 5px; margin: 0 5px; border: 1px solid #ddd; max-width: 558px" placeholder="Product Name..." required>{{$order_details->product_name}}</textarea>
                                       <i class="fa fa-trash-o dlt-itm" data-pid="{{$order_details->product_id}}" style="cursor: pointer" aria-hidden="true"></i>
                                    </div>
                                    <div style="width: 790px; margin: auto;">
                                       <div class="form-group quantity_area" style="margin-bottom: 5px; ">
                                          ...
                                          <input type="number" name="product_quantity[]" class="form-control check_integer" max="99999999" min="1" id="" value="{{$order_details->quantity}}" required>
                                       </div>
                                       <div class="form-group" style="margin-bottom: 5px; position: relative; left: 6px;">
                                          ...
                                          <select name="product_unit[]" class="form-control" style="width: 207px;" required>
                                             ...
                                             @if($unit->id == $order_details->unit_id){
                                       ...
                                       <div class="form-group unit_price_area" style="width: 562px;text-align: left;margin-bottom: 5px">
                                          ...
                                          <input type="text" name="product_unit_price[]" class="form-control check_number" min="0" max="9999999999" id="" value="{{$order_details->unit_price}}" required>
                                          <span>Product Price: US $ <span class="product_nprice">0</span></span>
                                       </div>
                                       <textarea name="product_details[]" style="margin-top:5px;padding: 7px;width: 552px; background: white; border: 1px solid #ddd; resize: both;" placeholder="Fill in any product details to make it as clear as possible for suppliers to understand your requirements." rows="2" type="text" height="100%">{{$order_details->product_details}}</textarea>
                                    </div>
                                 </div>
                                 @endforeach
                                 @else
                              ...
                              <div style="">
                                 ...
                                 <br>
                                 <!-- <p style="max-width: 552px;margin: 0 auto;margin-top: 10px">You may upload up to 5 attachments. The maximum attachment size is 5MB each. Supported formats include:XLSX,XLS,DOC,DOCX,JPG,PNG,JPEG,GIF,TIF,PDF,TXT</p> -->
                              </div>
                        ...
                        <div class="con-desc">
                           ...
                           <div class="form-group" style="width: 562px;text-align: left;display: flex;margin: auto; margin-top: 5px;">
                              ...
                              <input type="text" name="shipping_fee" class="form-control check_number" id="" min="0" max="9999999999" style="flex: 1" value="{{$order->shipping_fee}}" required>
                           </div>
                           <div class="form-group" style="width: 562px;text-align: left;display: flex;margin: auto; margin-top: 5px;">
                              <label style="width: 135px; text-align: right;margin-right: 10px" for="">Insurance Charge:</label>
                              <input type="text" name="insurance_charge" class="form-control check_number" min="0" max="9999999999" style="flex: 1" value="{{$order->insurance_charge}}" required>
                           </div>
                           <div class="form-group" style="width: 562px;text-align: left;display: flex;margin: auto; margin-top: 5px;">
                              <label style="width: 135px; text-align: right;margin-right: 10px" for="">Shipment Date:</label>
                              <label><input type="radio" name="shipment_date_type" class="" value="specific-day" {{$order->shipment_date_type=='specific-day'?'checked':''}}> Ship on specific day</label>
                           </div>
                           <div class="form-group specific_date_area" style="width: 562px;text-align: left;display: flex;margin: auto; margin-top: 5px; @if($order->shipment_date_type=='specific-day') @else display:none; @endif">
                              <label style="width: 135px; text-align: right;margin-right: 10px" for=""></label>
                              <input type="text" name="shipment_date" value="{{$order->shipment_date}}" class="form-control" placeholder="yyyy/mm/dd">
                           </div>
                           <div class="form-group" style="width: 562px;text-align: left;display: flex;margin: auto; margin-top: 5px;">
                              <label style="width: 135px; text-align: right;margin-right: 10px" for=""></label>
                              <label><input type="radio" name="shipment_date_type" class="" value="after-supplier" {{$order->shipment_date_type=='after-supplier'?'checked':''}}> Ship after supplier receives the initial payment</label>
                           </div>
                           <div class="form-group after_payment_area" style="width: 562px;text-align: left;display: flex;margin: auto; margin-top: 5px; @if($order->shipment_date_type=='after-supplier') @else display:none @endif ">
                              <label style="width: 135px; text-align: right;margin-right: 10px" for=""></label>
                              <label><input type="number" name="shipment_days_after" style="width: 225px;" max="365" min="@if($order->shipment_date_type=='after-supplier') 1 @else 0 @endif" value="{{$order->shipment_days_after}}" class="form-control check_integer"> &nbsp;day(s) after supplier </label>
                           </div>
                        </div>
                           ...
                           <div class="form-group" style="width: 562px;text-align: left;display: flex;margin: auto; margin-top: 5px;">
                              ...
                              <p style="margin:0;padding: 0;padding-top: 10px;">
                                 <div class="input-group">
                                    ...
                                    <input type="number" class="form-control check_integer" style="z-index: 1;" aria-label="Amount (to the nearest dollar)" max="9999999999" min="0" name="initial_payment" value="{{$order->initial_payment}}" required>
                                 </div>
                              </p>
                           </div>
                        ...
                        <div class="con-desc" style="border: 1px solid lightblue">
                           ...
                           <div class="form-group" style="width: 562px;text-align: left;margin: auto; margin-top: 5px;">
                              ...
                              <input type="radio" name="coverage_type" value="post-shipment" class="form-control" id="" style=" margin-top: -3px; margin-right: 5px;" {{$order->coverage_type=='post-shipment'?'checked':''}}> Post-delivery coverage
                           </div>
                           ...
                           <div class="form-group" style="width: 562px;text-align: left;margin: auto; margin-top: 5px;">
                              ...
                              <input type="radio" name="coverage_type" class="form-control" id="" value="pre-shipment" style=" margin-top: -3px; margin-right: 5px;z-index: 1;" {{$order->coverage_type=='pre-shipment'?'checked':''}}>Pre-shipment coverage (Order amount must > US $1000)
                           </div>
                           <div class="form-group" style="width: 562px;text-align: left;display: flex;margin: auto; margin-top: 5px;">
                              <label style="width: 135px; text-align: right;margin-right: 10px" for=""></label>
                              <ul style="flex: 1">
                        ...
                        <div class="con-desc" style="border: 1px solid transparent">
                           ...
                           <textarea name="remark" style="margin-top:5px;width: 100%; background: white; border: 1px solid #ddd; resize: both;" placeholder="Fill in any product details to make it as clear as possible for suppliers to understand your requirements." rows="6" type="text" height="100%">{{$order->messages}}</textarea>
                                 ...
                                 <span placeholder="Please entry products" value="" class="nxt-slect">
                                    <div class="next-select-inner-wrapper">
                                       <div class="next-select-inner">
                                          <input style="border:0 none; text-align: left;float: left;padding-left: 10px; width: 100%;" id="myInput" onkeyup="myFunction()" tabindex="0" value="" placeholder="Please entry products"></div>
                                    </div>
                                 </span>
                              </div>
                           </div>
            ...
            <div class="modal-body">
               ...
               <div class=" next-dialog-footer">
                  <div style="margin-top: 12px;">
                     ...
                     <!-- <div style="flex: 1 1 auto; display:block;padding: 0 4px; width: auto; float: right;">
				         <button type="button" class="nxt-bt next-btn-medium"><i class="fa fa-angle-left" aria-hidden="true" style="font-size: 25px; margin-top: 6px;"></i></button>
				         	<div class="next-pagination-display"><em>1</em>/111</div>
				         <button type="button" class="nxt-bt next-btn-medium"><i class="fa fa-angle-right" aria-hidden="true" style="font-size: 25px; margin-top: 6px;"></i></button>
				         </div> -->
                  </div>
               </div>
            </div>
...
<script type="text/javascript">
	   ...
	   $(document).on({
	      change: function() {
	         if ($(this).val() == 'after-supplier') {
	            ...
	            $('[name="shipment_days_after"]').attr('min', 1);
	         } else {
	            $('.specific_date_area').show();
	            $('.after_payment_area').hide();
	            $('[name="shipment_days_after"]').attr('min', 0);
	         }
	      }
	...
	template += '<div class="con-p-info" style="max-width: 790px; margin: auto; margin-bottom: 5px;">\
	  						<input type="hidden" name="selected_products[]" value="0" required>\
								<span class="index" style="margin-right: 5px"></span>\
								<div style="height: 100px;width: 100px;text-align: center;border: 1px solid #ddd;position:relative;"><img src="{{URL::to("resources/assets/gold/plus-Icon.png")}}" class="select_p_image" style="margin-top: 35px;cursor: pointer;"><input style="display:none;" type="file" name="product_image[]" class="image_p" required></div>\
	...
	$(document).on({
	   click: function() {
	      $(this).parent().children('.select_p_image').attr('src', '{{URL::to("resources/assets/gold/plus-Icon.png")}}');
	...
	var old_Shipping_Method = '{{$order?$order->shipping_method:"express"}}';
	var old_Trade_terms = '{{$order?$order->payment_terms:"FOB"}}';
	$('[name="shipping_method"]').val(old_Shipping_Method);
	$('[name="payment_terms"]').val(old_Trade_terms);
