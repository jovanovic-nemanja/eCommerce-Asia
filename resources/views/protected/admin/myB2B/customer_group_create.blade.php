...
@section('content')
    ...
    @endif
                ...
                <div class="row">
                    <div class="col-md-12">
                        {!! Form::open(array('route'=>array('admin.customer.group_store'),'id'=>'form1','class'=>'form-horizontal  form-row-seperated','files'=>true)) !!}
                                            ...
                                            <div class="tab-pane active" id="tab_general">
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        <label class="col-md-3 control-label">Group Name: <span class="required">
                                                        * </span>
                                                        </label>
                                                        <div class="col-md-9">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        * </span>
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea class="form-control " id="description" name="description" placeholder="Group Description..."></textarea>
                                                        </div>
                                                    </div>
