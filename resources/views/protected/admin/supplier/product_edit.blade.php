   ...
   <div class="row" style="">
    ...
    ?>
         ...
         <?php
            ...
            ?>
         @if($role->role_id ==2)
         <form action="{{ URL::to('admin/profiles/sellerproduct_update', $product->id) }}" method="post" enctype="multipart/form-data" accept-charset="UTF-8" class="form-horizontal product_info_form form-row-seperated">
            @else

            <form action="{{ URL::to('supplier/product_update', $product->id) }}" method="post" enctype="multipart/form-data" accept-charset="UTF-8" class="form-horizontal product_info_form form-row-seperated">
                        ...
                        <div class="col-md-8" style="padding-top: 1%;">
                           <table class="table">
                              <tbody class="copied_template">
                                 ...
                                 <tr>
                                    <td>Name</td>
                                    <td><input name="attr_id[]" type="hidden" value="{{ $attr->bdtdcAttribute->id }}"><input type="text" name="product_attr_name[]" value="{{ $attr->bdtdcAttribute->name ?? '' }}" class="form-control"></td>
                                    <td>Value</td>
                                    <td><input type="text" name="product_attr_value[]" value="{{ $attr->bdtdcAttribute->value ?? ''  }}" class="form-control"></td>
                                    <?php if($i_remove == 1){ ?>
                                 ...
                                 @if(!$attribute_found)
                                 <tr> <input name="attr_id[]" value="0" type="hidden">
                                    <td>Name:</td>
                                    <td><input style="height:27px;padding-bottom:1%;font-size:12px" name="product_attr_name[]" class="form-control" type="text"></td>
                                    <td>Value:</td>
                                    <td><input style="height:27px;padding-bottom:1%;font-size:12px" name="product_attr_value[]" class="form-control" type="text"></td>
                                    <td> <button class="btn btn-primary btn-xs add_more_attribute_btn_for_edit"><i class="fa fa-plus" style="padding:2px;"></i></button> </td>
                                 </tr>
                                 @endif
                              </tbody>
                           ...
                           <table class="table">
                              <tbody>
                                 <tr>
                                    ...
                                    <td>
                                    <input style="height:28px;padding-bottom:1%;font-size:12px;padding-top:0%" type="text" name="product_groups" class="form-control" value="Admin Group"> 
...
<script type="text/javascript">
	(function() {
	   ...
	   $(document).on({
	      click: function(e) {
	         e.preventDefault();
	         var url = window.location.origin + "/buyerseller/public/admin/profiles/add_product_group/" + $("[name='add_group_name[]']:first").val();
