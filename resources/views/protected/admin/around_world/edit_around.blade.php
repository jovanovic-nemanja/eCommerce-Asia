...
@section('content')
    ...
    @endif
                ...
                <div class="row">
                    <div class="col-md-12">
                        <input type="hidden" name="hidden_categorie" value="{{ $around_world->id }}">
                       <!--  <form class="form-horizontal form-row-seperated" action="#"> -->
                        {!! Form::open(array('route'=>array('admin.aroundworld-update',$around_world->id),'id'=>'form1','class'=>'form-horizontal  form-row-seperated trade_edit_form','files'=>true)) !!}
                                            ...
                                            <div class="tab-pane active" id="tab_general">
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            {!! Form::text('title',$around_world->title,['class'=>'form-control','placeholder'=>'Title','style'=>'width:38%']) !!}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            <textarea class="form-control maxlength-handler" rows="8" id="meta_description" name="description" maxlength="1000">{{ $around_world->description }}</textarea>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                            {!! Form::text('url',$around_world->url,['class'=>'form-control','placeholder'=>'Meta-Title','style'=>'width:38%']) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="panel panel-success">
                                                  ...
                                                  <div class="panel-body">
                                                    ...
                                                    <div class="row fileupload-buttonbar">
                                                        <div class="col-xs-5">
                                                            <h4>Image</h4>
                                                            <img class="img-thumbnail" style="width:58%;height: 108px;margin-bottom: 2%;" src="{{ URL::to('uploads',$around_world->image) }}" alt="">
                                                        </div>
                                                        <div class="col-lg-12">
...

      {
        ...
        function form_validate(form_id){
            ...
            if(url !== 'regex:/^(https?:\/\/)?([\da-z\.-]+)\.([a-z\.]{2,6})([\/\w \.-]*)*\/?$/') {
                ...
                msg += error+". 'your url have to be a valid url (try putting https:// or another prefix at the beginning)' <br/>";
            }
            if(error != 0){
