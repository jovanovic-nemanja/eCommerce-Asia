...
@section('content')
    ...
    @if (session()->has('flash_message'))
        ...
        <div class="row">
            <div class="col-md-12">
                <h3>All Available Around World list</h3>
                <table class="table">
                    <thead>
                    ...
                    @foreach($around_world as $data)
                        <tr>
                            ...
                            <td>
                                <a href="{{ URL::to('admin/aroundworld-edit',$data->id) }}" class="btn btn-xs btn-info">Edit</a>
                                <a href="{{ URL::to('admin/aroundworld-delete',$data->id) }}" class="btn btn-xs btn-danger trade_delete">Delete</a>
