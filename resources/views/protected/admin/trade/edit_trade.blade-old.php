                                                    ...
                                                    <div class="col-md-12 form-group">
                                                        ...
                                                        * </span>
                                                        ...
                                                        <div style="margin-left:1.5%" class="col-md-8 navbar-form">
                                                            ...
                                                            <div class="form-group" style="box-shadow: none;background: transparent;">
                                            ...
                                            <div class="tab-pane" id="tab_meta">
                                                <div class="form-body" >
                                                    ...
                                                    <div class="col-md-12 form-group" style="margin-top: 30px">
                                                        ...
                                                        <div class="col-md-8">
                                                            {!! Form::text('title',$pre_trade_data->title,['class'=>'form-control','placeholder'=>'Title']) !!}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            {!! Form::text('meta_title',$pre_trade_data->meta_title,['class'=>'form-control','placeholder'=>'Meta-Title']) !!}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            {!! Form::text('meta_keyword',$pre_trade_data->meta_keyword,['class'=>'form-control','placeholder'=>'Meta-keyword']) !!}
                                                        </div>
                                                    </div>
