                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="col-md-12 form-group">
                                                        ...
                                                        * </span>
                                                        ...
                                                        <div class="col-md-8">
                                                            {!! Form::date('date',null,['class'=>'form-control date','placeholder'=>'Date']) !!}
                                                        </div>
                                                    </div>
                                                        ...
                                                        * </span>
                                                        ...
                                                        <div style="margin-left:1.5%;" class="col-md-8 navbar-form">
                                                            <div class="form-group">
                                                                {!! Form::text('start_time',null,['class'=>'form-control text-primary','placeholder'=>'Start Time (Ex: 10:52:AM)']) !!}
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                {!! Form::text('end_time',null,['class'=>'form-control text-primary','placeholder'=>'End-time (Ex: 10:52:AM)']) !!}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 form-group">
                                                        ...
                                                        * </span>
                                                        ...
                                                        <div class="col-md-8">
                                                            {!! Form::text('vanue',null,['class'=>'form-control','placeholder'=>'venue']) !!}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12 form-group">
...
//            if(text){
            var error = 0;
            var msg='';
            var country_id = $('#location_of_reg:selected').val();
