   ...
   <div class="col-md-12">
      ...
      <div class="portlet box grey-cascade">
         <div class="portlet-title">
            <div class="caption">
               <i class="fa fa-globe"></i>Manage Archive Users
            </div>
            <div class="tools">
            ...
            <table class="table table-striped table-bordered table-hover" id="sample_1">
               ...
               <tbody>
                  ...
                  <tr class="odd gradeX">
                     ...
                     <td>
                        <a onclick="return confirm('Are you sure want to delete the user permanently?')" type="button" class="btn btn-danger btn-xs delete_product" href="{{ URL::to('admin/profiles/permanentdeleteuser/'. $user->id) }}"><i class="fa fa-times"></i></a>
                     </td>
                     <td>
                        <a onclick="return confirm('Are you sure want to approve the user?')" type="button" class="btn btn-success btn-xs " href="{{ URL::to('admin/profiles/approveuser/'. $user->id) }}"><i class="fa fa-hand-o-up" aria-hidden="true"></i></a>
                     </td>
                  </tr>
                  @endforeach
               </tbody>
