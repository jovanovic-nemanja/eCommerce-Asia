      ...
      <div class="portlet light">
         <div class="portlet-title">
            ...
            <div class="actions btn-set">
               ...
               <span onClick="return form_validate('form1');" class="btn green-haze btn-circle"><i class="fa fa-check"></i> Form validation </span>
               <button class="btn green-haze btn-circle" onClick="return form_validate('form1');"><i class="fa fa-check-circle"></i> Save & Continue Edit</button>
                     ...
                     <div class="panel panel-success"  style="margin-top: 100px;">
                        ...
                        <div class="panel-body">
                           <ul>
                              ...
                              <li>
                                 Only image files (<strong>JPG, GIF, PNG, BMP</strong>) are allowed in this demo (by default there is no file type restriction).
                              </li>
                              <li>
