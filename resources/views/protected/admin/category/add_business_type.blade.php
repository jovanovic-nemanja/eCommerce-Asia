...
@section('content')
    ...
    @endif
                ...
                <div class="row">
                    <div class="col-md-12">
                        {!! Form::open(array('route'=>array('admin.category.store_businessType'),'id'=>'form1','class'=>'form-horizontal  form-row-seperated','files'=>true)) !!}
                                                ...
                                                <div class="form-body">
                                                    <div class="form-group">
                                                        ...
                                                        * </span>
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" id="name" name="name" placeholder="Business Type Name">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        * </span>
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea class="form-control" id="description" name="description" placeholder="Business Type description"></textarea>
                                                        </div>
                                                    </div>
                                                   <div class="form-group">
                                                        ...
                                                        * </span>
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" id="sort" name="sort" placeholder="123...">
                                                        </div>
                                                    </div>
...
Demo.init(); // init demo features
         ...
         function form_validate(form_id){
            ...
            if(desc === ''){
             ...
             if(sort === ''){
                error++;
                $('#sort').css('border','1px solid red');
               msg += error+". Sort Order Required <br/>";
