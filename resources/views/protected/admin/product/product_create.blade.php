...
@section('content')
				...
				<div class="row">
					<div class="col-md-12">
						{!! Form::open(array('route'=>array('admin.product-add'),'id'=>'form1','class'=>'form-horizontal  form-row-seperated','files'=>true)) !!}
											...
											<div class="tab-pane active" id="tab_general">
												...
												<div class="form-body">
													...
													<div class="form-group">
														...
														<div class="col-md-10">
															{!! Form::text('brand_name',null,['class'=>'form-control','placeholder'=>'Brand Name','style'=>'width:38%']) !!}
														</div>
													</div>
													<div class="form-group">
