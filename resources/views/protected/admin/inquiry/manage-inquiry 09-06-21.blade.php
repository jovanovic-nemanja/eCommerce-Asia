...
<!--                                <div class="tools">
                            ...
                            <div class="portlet-body">
                                ...
                                <table class="table table-striped table-bordered table-hover th-bg">
                                <thead>
                           
                                <tr>
                                    <th>
                                        <label><input type="checkbox" name="check_all"></label>
                                    </th>
                                    <th>
                                        ID
                                    </th>
                        ...
                        ?>
                                ...
                                <tr class="">
                                    <td class="check_single_td">
                                        <label><input type="checkbox" name="check_single"></label>
                                    </td>
                                    <td class="id_td">
                                        {{$i->id}}
                                    </td>
