@extends('fontend.master_dynamic')
	@section('page_css')
		<link property='stylesheet' href="{!! asset('css/trade-services/buyer-protection.css') !!}" rel="stylesheet">
	@endsection
...
<div class="row padding_0" style="background-color: #fff; margin-bottom: 28px; padding-bottom: 28px;border-bottom:1px solid rgba(0,0,0,.1)">
				<div class="col-sm-12 col-md-12 col-lg-12" style=" border-bottom: 1px solid #ccc;">
							<h4 class="glbao-h4">Ways to trade on BuyerSeller.Asia
							   <!-- <span class="pull-right" style="font-size: 18px; margin-top: 6px;"><a href="{{URL::to('bdtdc/FAQs')}}">FAQ</a></span> -->
							</h4>
				</div>
				<div class="col-sm-12 col-md-12 col-lg-12 padding_0">
					 <ul class="step-ul" style="padding-top: 4%; padding-bottom: 4%;">
					 		<li class="step-ul-li" style="background: #F2F2F2; margin-bottom: 15px;">
					 		...
					 		<li class="step-ul-li" style="background: #EFF6FE;margin-bottom: 15px;">
				...
				<div>
				<div class="col-sm-12 col-md-12 col-lg-12">
					 <p class="payment"><img itemprop="image" style="margin: 0;"  src="{!! asset('assets/fontend/bdtdc-images/buyer-affirms-order.png') !!}" alt="confirms order"><span style="background: #EFF6FE;padding: 12px 20px;  line-height:35px; margin-left: 10px;">BuyerSeller.Asia holds payment until buyer affirms order</span></p>
					</div>
				</div>
				<div class="col-sm-12 col-md-12 col-lg-12">
					...
					<p class="how-trade-p">Buyers who wish to trade with BuyerSeller suppliers can directly submit order requests on
...
received.</p>
				...
				<div class="col-sm-12 col-md-12 col-lg-12"  style=" border-bottom: 1px solid #ccc;">
							<h4 class="glbao-h4">Guarantees of Three</h4>
				</div>
				<div class="col-sm-12 col-md-12 col-lg-12" style="    border-bottom: 1px solid #ccc;">
						<div class="col-sm-2 col-md-1 col-lg-1">
						...
						<div class="col-sm-10 col1-md-11 col-lg-11">
							...
							<p class="how-trade-p">To pay for the order safely, buyer can use the BuyerSeller payment method. The bank account
...
by the supplier and Logistics Protection Period (90 days by Air/120 days by Ship).
 ...
 <div class="col-sm-12 col-md-12 col-lg-12">
		<div class="button-line"><a itemprop="url"  href="{{URL::to('order-protect',null)}}" class="large-button22 " target="_blank" style="border-radius: 5px !important;">Order with Buyer Protection</a></div>
	</div>
</div> 
