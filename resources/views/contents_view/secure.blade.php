...
@section('page_css')
  <link property='stylesheet' href="{!! asset('css/trade-services/secure-payment.css') !!}" rel="stylesheet">
  @endsection
@section('content')
...
<div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                    <ul class="top-path" style="padding-bottom: 8px;" itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li class="top-path-li" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="{{URL::to('FooterPage/pages/Secure_Payment',37)}}" class="top-path-li-a"><span itemprop="name">Secure Payment</span><i class="fa fa-angle-right top-path-icon"></i></a></li>
                        
                    </ul>
            </div>
    
  </div>
<div id="secure" class="row" style="background-color:#fff!important; position: relative;">
...
<div class="row" style="background-color:#333333;height:50px;">
      <p style="color:#E8F1FA;padding-left:9%;padding-top:9px;font-size: 16px;line-height: 30px;">
            On 01 Jan. 2019, Escrow Service changed its name to BuyerSeller Secure Payment. The service remains the same.</p>
</div>
<div class="row" style="background-color:#E8F1FA;">
      <div class="col-sm-4" style="padding-top:20px;padding-bottom:20px;">
            <div class="col-sm-12">
                  <div class="col-sm-3">
                        <img itemprop="image" style="height:1%;" src="{!! asset('assets/helpcenter/images/l.png') !!}" alt="Buyer Seller" />
                  </div>
                  <div class="col-sm-9">
      ...
      <div class="col-sm-4" style="padding-top:20px;padding-bottom:20px;">
            <div class="col-sm-12">
                  <div class="col-sm-3">
                        <img itemprop="image" style="height:1%;" src="{!! asset('assets/helpcenter/images/k.png') !!}" alt="Buyer Seller" />
                  </div>
                  <div class="col-sm-9">
                        <p style="font-weight: 400;font-size: 1.5em;color: #333;">
      ...
      <div class="col-sm-4" style="padding-top:20px;padding-bottom:20px;">
            <div class="col-sm-12">
                  <div class="col-sm-3">
                        <img itemprop="image" style="height:1%;" src="{!! asset('assets/helpcenter/images/m.png') !!}" alt="Buyer Seller" />
                  </div>
                  <div class="col-sm-9">
                        <p style="font-weight: 400;font-size: 1.5em;color: #333;">
...
<div class="row" style="background-color:#fff!important;margin-top:30px;margin-bottom:30px;">
      <div class="col-sm-8" style="border: 1px solid rgb(221, 221, 221);padding: 20px 10px 20px 30px;vertical-align: top;">
            <p style="font-size: 2em;font-weight: 400;line-height: 1;">             
                  What is BuyerSeller&#39;s Secure Payment service?
            </p>
            <p style="color: #333;font: inherit;font-size: 12px;line-height: 1.5em;">
                  Buyer Seller Secure Payment plans to give a sheltered payment service to all gatherings occupied

with global exchange. By collaborating with a free online payment platform (Bdpay), Buyer Seller
...
gives payment security to both purchasers and suppliers.
      ...
      <div class="col-sm-4" style="border: 1px solid rgb(221, 221, 221);padding: 20px 10px 20px 30px;vertical-align: top;">
            ...
            <p style="color: #333;font: inherit;font-size: 12px;line-height: 1.5em;padding-bottom:17px;">
                 On 1, Jan. 2019, Escrow Service changed its name to BuyerSeller Secure Payment.  
            </p>
            
      </div>
      
</div>
<div class="row" style="background-color:#fff!important;margin-top:30px;margin-bottom:30px;/*border: 1px solid rgb(221, 221, 221);*/padding: 20px 10px 64px 30px;vertical-align: top;">
      <div style="float: left;font-size: 2em;font-weight: 400;line-height: 1">
           Ways it works
            <p style="font-size: 14px;display: inline-block;padding-top: 5px;margin-left: 10px;color: #666;"> 
            Start order /Wholesale order</p>
      </div>
      
      <div class="col-sm-12 padding_0" style="">
        <div class="col-sm-12-col-md-12 padding_0">
            <div class="col-sm-2 page_scecure" style="">
                  <div class="step-item-box">
                   <i class="step-label">1</i> 
                   <span class="payment-step">Buyer request order online</span>
                   </div>
            </div>
            <div class="col-sm-2 page_scecure" style="">
                  <div class="step-item-box">
                    <i class="step-label">2</i> <span class="payment-step">Buyer places payment</span>
                   </div>
            </div>
            <div class="col-sm-2 page_scecure" style="">
                  <div class="step-item-box">
                   <i class="step-label">3</i><span class="payment-step">Supplier dispatches order</span>
                   </div>
            </div>
            <div class="col-sm-3 page_scecure" style="">
                  <div class="step-item-box">
                   <i class="step-label">4</i><span class="payment-step">Buyer receives and confirms order online</span> 
                   </div>
            </div>
              <div class="col-sm-3 page_scecure">
                  <div class="step-item-box">
                   <i class="step-label">5</i><span class="payment-step">Supplier receives payment</span>
                   </div>
            </div>
     ...
     <div class="col-sm-12-col-md-12 padding_0" style="clear:both; display:block;">
        <p style="clear:both;padding-top:16px; line-height:20px; font-size:12px; text-align:left;color:#666; width:88%;">Tips: Buyer Seller will send notifications via E-mail to the supplier and buyer at every step of the process. Please be

aware that emails from: transaction@buyerseller.asia .BuyerSeller are notifications containing your order.</p>
     </div>
</div>

<div class="row" style="background-color:#fff!important;margin-top:30px;margin-bottom:30px;">
      <div class="col-sm-9" style="border-right: 1px solid rgb(221, 221, 221);padding: 20px 10px 20px 30px;vertical-align: top;">
            <p style="font-size: 2em;font-weight: 400;line-height: 1;">             
...
keeping the products. 
      ...
      <ul class="col-sm-3 col-xs-12" style="padding: 20px 10px 20px 30px;vertical-align: top;">
...
<div class="row" style="background-color:#fff!important;margin-top:30px;margin-bottom:30px;border: 1px solid rgb(221, 221, 221);padding: 20px 10px 20px 30px;vertical-align: top;">
     ...
     <div class="col-sm-12">
           <div   class="col-sm-4 footer-shadow" style="padding-top:20px;">
                 <div class="col-sm-3">
...
supplier.
           ...
           <div class="col-sm-4" style="padding-top:20px;">
                 ...
                 <div class="col-sm-9">
                       <p style="font-size:14px;line-height: 1;font-weight: 400;color: #333; line-height:20px;">Heighten the dispute to BuyerSeller&#39;s Customer Service Team
                       </p>
                       <p>
...
<div class="row" style="background-color:#fff!important;margin-top:30px;margin-bottom:3%;border: 1px solid rgb(221, 221, 221);padding: 20px 10px 20px 30px;vertical-align: top;">
      <div class="col-sm-12">
            <p style="font-size: 1.6em;line-height: 1;font-weight: 400;padding-bottom:10px;padding-top:10px;">
                  BuyerSeller Secure Payment supports the following payment methods:</p>
      </div>
      <div class="col-sm-12" style="">
            <div class="col-sm-2 paymt-cd">
                  
                     <p>
                  <img itemprop="image" style="height:80px;width:50px;" src="{!! asset('assets/helpcenter/images/master.jpg') !!}" alt="Buyer Seller" />
                  MasterCard</p>    
            ...
            <div class="col-sm-2 paymt-cd">
                     ...
                     <p>
                        <img itemprop="image" style="height:80px;width:50px;" src="{!! asset('assets/helpcenter/images/maesto.png') !!}" alt="Buyer Seller" />
                        Maestro</p>   
            ...
            <div class="col-sm-2 paymt-cd">
                       ...
                       <p>
                        <img itemprop="image" style="height:80px;width:70px;" src="{!! asset('assets/helpcenter/images/visa.jpg') !!}" alt="Buyer Seller" />
                        Visa</p>   
            ...
            <div class="col-sm-2 paymt-cd" style="padding-top:30px;">
                        ...
                        <img itemprop="image" style="height:40px;width:120px;" src="{!! asset('assets/helpcenter/images/western.png') !!}" alt="Buyer Seller" />
                        
            </div>
            <div class="col-sm-1 paymt-cd" style="padding-top:30px;">
                  
                        <img itemprop="image" style="height:40px;width:80px;" src="{!! asset('assets/helpcenter/images/bank.jpg') !!}" alt="Buyer Seller" />
                       
            </div>
            <div class="col-sm-2 paymt-cd" style="padding-top:30px;">
                
                        <img itemprop="image" style="height:40px;width:130px;padding-left:20px;" src="{!! asset('assets/helpcenter/images/web.png') !!}" alt="Buyer Seller" />
                        
            </div>
            <div class="col-sm-1 paymt-cd" style="padding-top:30px;">
                  
                        <img itemprop="image" style="height:40px;width:80px;" src="{!! asset('assets/helpcenter/images/qiwi.png') !!}" alt="Buyer Seller" />
